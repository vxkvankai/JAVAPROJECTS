...
public class DateAndCurrencyHelper {
    ...
    public static boolean compareCurrency(BigDecimal actual, BigDecimal expected, BigDecimal roundingError) {
        log.info("Comparing {} to {} with rounding error: {}", actual, expected, roundingError);
        boolean firstCondition = actual.compareTo(expected) == 0;
        boolean secondCondition = actual.add(roundingError).compareTo(expected) == 0;
        boolean thirdCondition = actual.subtract(roundingError).compareTo(expected) == 0;
        boolean fourthCondition = (actual.add(roundingError).compareTo(expected) > 0 && actual.subtract(roundingError).compareTo(expected) < 0);
