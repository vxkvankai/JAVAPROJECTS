...
public class PaymentComingDueAlert extends D3Alert {
    ...
    public void triggerAlert() throws D3ApiException, ConduitException {
        ...
        attributeList.add(new D3AccountAttribute(D3AccountAttributes.MINIMUM_PAYMENT_DUE.getConduitCode(), AttributeType.MONEY, true, 0, RandomHelper.getRandomCurrencyValue(25, 200)));
        attributeList.add(new D3AccountAttribute(D3AccountAttributes.PAYMENT_DUE_DATE.getConduitCode(), AttributeType.DATE, true, 0, DATE_FORMAT.print(ONE_WEEK_FROM_TODAY)));
