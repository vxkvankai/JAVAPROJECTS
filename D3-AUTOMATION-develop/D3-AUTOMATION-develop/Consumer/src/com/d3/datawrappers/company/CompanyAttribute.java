...
public enum CompanyAttribute {
    ...
    ACCOUNTS_ESTATEMENTS_PAPER_AND_ELCETRONIC_ENABLED("accounts.estatement.paperAndElectronic.enabled"),
    ACCOUNTS_ESTATEMENTS_UN_ENROLL("accounts.estatement.unenroll.enabled"),
    ACCOUNTS_OVERDRAFT_PROTECTION("accounts.overdraft.protection.enabled"),
    ACCOUNTS_OVERDRAFT_PROTECTION_CHECKS("accounts.overdraft.protection.checks.enabled"),
    ACCOUNTS_OVERDRAFT_PROTECTION_MOBILE("accounts.overdraft.protection.mobile.enabled"),
    ACCOUNTS_OVERDRAFT_PROTECTION_PDF_VERIFICATION("overdraft.protection.pdf.verification.enabled"),
    ...
    MONEY_MOVEMENT_PRINCIPLE_ONLY("moneyMovement.principalOnly.enabled"),
    ...
    CURRENT_MONTH_STATUS("dashboard.cashflow.status"),
    NET_WORTH("dashboard.networth.assets"),
    DASHBOARD_PLAN_ENABLED("dashboard.plan");
