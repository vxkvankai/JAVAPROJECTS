...
public class MyAccountsSection extends Accounts<MyAccountsSection> {
    ...
    @FindBy(name = "enrollAllAccounts")
    private CheckBox goPaperlessAllAccountsCheckBox;

    @FindBy(css = "div.user-alert")
    private List<Element> userAlertInfo;


    @FindBy(css = " button.cancel-view")
    private Element goPaperlessCancelButton;
    ...
    public boolean verifyGoPaperlessMultipleAccountsEnrolled(List<D3Account> accounts) {
        String message = getDisplayedElement(userAlertInfo).getText();

        for (D3Account account : accounts) {
            try {
                checkIfTextContains(message, "Text NotFound", account.getName());
            } catch (TextNotContainedException e) {
                log.error("Account name not found ", e);
                return false;
            }
        }
        return true;
    ...
    public MyAccountsSection clickGoPaperlessAllAccountsCheckBox() {
        goPaperlessAllAccountsCheckBox.check();
        return this;
    ...
    public MyAccountsSection clickGoPaperlessCancelButton() {
        goPaperlessCancelButton.click();
        return this;
    }
    ...
    public boolean isOverDraftSaveButtonEnabled() {
        try {
            ...
            log.error("No save button found", e);
            return false;
        }
    }
    ...
    public boolean isGoPaperlessButtonDipalyed() {
        try {
            return goPaperlessButton.isDisplayed();
        } catch (NoSuchElementException e) {
            return false;
        }
    }
    ...
    @Step("Click the brokerage access button")
    ...
    public boolean isEStatementHTMLDisplayed() {
        ...
        try {
            ...
            log.warn("EStatement Monthly Statement section check failed:", e);
            return false;
        }
