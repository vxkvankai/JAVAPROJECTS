...
public abstract class D3BankingApi extends D3BaseApi {
    ...
    public D3BankingApi(String baseUrl, Gson converterFactory) {
        retrofit = getNewRetrofitWithCustomConverter(baseUrl, converterFactory);
    }
    ...
    public Map<String, String> login(String username, String password, String challengeAnswer) throws D3ApiException {
        log.info("Attempting to login via the api for user: {}", username);
        ...
        service = retrofit.create(BankingService.class);
        log.info("Accepting terms of service for user: {}", username);
    ...
    public D3BankingApi switchToggleToBusinessMode() throws D3ApiException {
        log.info("Attempting to change toggle to business mode");
        BankingService service = retrofit.create(BankingService.class);
        ...
        log.info("Changing toggle to business mode was successful");
        return this;
    }

    public String getApiVersion() throws D3ApiException {
        log.info("Attempting to get current API version");
        BankingService service = retrofit.create(BankingService.class);
