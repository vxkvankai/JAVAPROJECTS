...
public class SecureMessages extends MessageSection<SecureMessages> {
    ...
    public boolean isMessageCreated(SecureMessage message) {
        ...
        try {
            ...
            logger.warn("Message subject not found", e);
            return false;
        }
        return true;
    }
    ...
    public boolean requiredFieldMessagingDisplays() {
        ...
        try {
            ...
            logger.warn("Required field messaging was not displayed", e);
            return false;
        }
    ...
    public boolean areCorrectMessagesDisplayed(String searchTerm) {
        return messages.stream().peek(Element::click).peek(element -> logger.info("Found Secure Message With Text: \n{}", element.getText()))
