...
public class EBillsPage extends MoneyMovementBasePage {
    ...
    public boolean isRecipientAvailableToAddAsEBiller(Recipient recipient) {
        try {
            ...
            logger.error("Recipient not available to add as E-Biller", e);
            return false;
        }
    }
        ...
        switch (eBill.getStatus()) {
            case FILED:
                try {
                    ...
                    logger.error("EBills L10 was not displayed correctly", e);
                    return false;
                }
            case PAID:
                try {
            ...
            case UNPAID:
                try {
                    ...
                    logger.error("EBills L10 was not displayed correctly, or Pay Now and File buttons were not displayed", e);
                    return false;
                }
    ...
    public boolean areAutoPayDetailsCorrect(D3EBill autoPay) {
        ...
        try {
            ...
            logger.error("EBills Auto Pay Information was not displayed correctly", e);
            return false;
        }
