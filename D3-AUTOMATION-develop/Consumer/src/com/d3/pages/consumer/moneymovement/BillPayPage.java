...
public class BillPayPage extends MoneyMovementBasePage {
    ...
    public boolean isBillPayMoreInfoNeededMessageDisplayed() {
        try {
            ...
            logger.warn("Bill Pay Info Needed message not displayed", e);
            return false;
        }
    ...
    public boolean isCorrectFormInformationDisplayed(D3User user) {
        ...
        try {
            ...
            if (emailContact == null) {
                logger.error("Email Contact for user was null");
                return false;
            }
            ...
            if (phoneContact == null) {
                logger.error("Phone contact for user was null");
                return false;
            }
            ...
            logger.warn("Correct Bill Pay Form information was not displayed", e);
            return false;
        }
