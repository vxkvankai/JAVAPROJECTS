...
public class LoginPage extends PageObjectBase {
    ...
    public LoginPage clickSubmitButton() {
        logger.info("Clicking the submit button for login");
    ...
    public LoginPage enterSecretQuestionAnswers(String answer) {
        logger.info("Entering secret answer for questions: {}", answer);
    ...
    private void loginManually(String userName, String passWord, String secretQuestion) {
        logger.info("Entering username into field: {}", userName);
        enterUserName(userName);
        logger.info("Entering password into field: {}", passWord);
        ...
        waitUntilTextPresent("Submit");
        logger.info("Clicking the submit button for secret answers");
        clickSubmitButton();
