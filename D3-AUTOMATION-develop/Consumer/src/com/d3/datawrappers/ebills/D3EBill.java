...
public class D3EBill implements Serializable {
    ...
    public static D3EBill createRandomPayNowTransfer(D3User user, Recipient recipient) {
        int ebillId = DatabaseUtils.getReceivedEBillId(user, recipient);
        ...
        transfer.setAmount(Double.valueOf(DatabaseUtils.getEBillAttribute(ebillId, AMOUNT_DUE_COLUMN)));
        transfer.setScheduledDate(DateTime.parse(DatabaseUtils.getEBillAttribute(ebillId, DUE_DATE_COLUMN)));
