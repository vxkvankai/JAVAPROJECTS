...
public class SingleTransfer extends D3Transfer {
    ...
    public static SingleTransfer createRandomTransfer(TransferableAccount toAccount, D3Account fromAccount, boolean createRandomNote) {
        ...
        try {
            ...
            amount = 0d;
            LoggerFactory.getLogger(SingleTransfer.class).error("Error creating a currency number. Setting amount to 0");
        }
    ...
    public String toString() {
        return String.format("Single Transfer to: %s, from: %s, amount: %s", getToAccount().getTransferableName(),
