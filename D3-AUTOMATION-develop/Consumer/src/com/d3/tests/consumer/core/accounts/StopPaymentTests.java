...
public class StopPaymentTests extends AccountsTestBase {
    ...
    private static final String PERMISSION = "d3Permission.stop.payment";
    ...
    public void verifyStopPaymentOnValidCheckRange(D3User user, D3Account account) {
        DatabaseUtils.updateCompanyAttributeValueString(CompanyAttribute.ACCOUNTS_STOP_PAYMENT.getDefinition(), TRUE_STR);
        DatabaseUtils.updateCompanyAttributeValueString(CompanyAttribute.ACCOUNTS_STOP_PAYMENT_CHECK_RANGES.getDefinition(), TRUE_STR);
    ...
    public void verifyStopPaymentHistory(D3User user, D3Account account) {
        DatabaseUtils.updateCompanyAttributeValueString(CompanyAttribute.ACCOUNTS_STOP_PAYMENT.getDefinition(), TRUE_STR);
        DatabaseUtils.updateCompanyAttributeValueString(CompanyAttribute.ACCOUNTS_STOP_PAYMENT_CHECK_RANGES.getDefinition(), FALSE_STR);
        DatabaseUtils.updateCompanyAttributeValueString(CompanyAttribute.ACCOUNTS_STOP_PAYMENT_HISTORY.getDefinition(), TRUE_STR);
    ...
    public void verifyStopPaymentNotAvailableWhenDisabled(D3User user, D3Account account) {
        DatabaseUtils.updateCompanyAttributeValueString(CompanyAttribute.ACCOUNTS_STOP_PAYMENT.getDefinition(), FALSE_STR);
