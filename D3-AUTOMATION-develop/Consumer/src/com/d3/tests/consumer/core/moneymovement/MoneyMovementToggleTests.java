...
public class MoneyMovementToggleTests extends MoneyMovementTestBase {
    ...
    public void verifyBillPayEnrollmentFundingAccounts(D3User user) {
        ...
        Assert.assertTrue(billpay.areFundingAccountsCorrect(DatabaseUtils.getMaskedUserAccounts(user)));
    }
    ...
    public void verifyMoneyMovementAvailableInternalAccounts(D3User user) {
        ...
        Assert.assertTrue(form.areDestinationAccountsCorrect(DatabaseUtils.getMaskedUserAccounts(user)));
        form.selectToAccount(accountToSelect);
        Assert.assertTrue(form.areSourceAccountsCorrect(DatabaseUtils.getMaskedUserAccounts(user)));
    }
