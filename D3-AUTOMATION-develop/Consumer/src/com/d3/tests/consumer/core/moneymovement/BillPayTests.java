...
public class BillPayTests extends MoneyMovementTestBase {
    ...
    public void verifyBillPayEnrollmentCancel(D3User user) {
        D3Account acct = user.getAccountPairs().get(0).getValue0();
        ...
        logger.info("Verifying the Add Company Recipient button does not show");
    ...
    public void verifyRequiredFieldsAndAuditRecord(D3User user) {
        ...
        String billPayEnrollmentId = DatabaseUtils.getAuditRecordAttributes(user, Audits.MM_USER_ENROLL)
