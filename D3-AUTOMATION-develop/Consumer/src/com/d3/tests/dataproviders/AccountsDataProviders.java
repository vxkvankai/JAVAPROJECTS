...
public class AccountsDataProviders extends DataProviderBase {
    ...
    public Object[][] getBasicUserWithHiddenAccounts(Method method) {
        ...
        for (D3User user : users) {
            ...
            try {
                ...
                logger.error("Error hiding account", e);
            }
    ...
    public Object[][] getBasicUserWithOneTimeInternalTransfer(Method method) {
        ...
        try {
            ...
            logger.error("Error adding transfer to the api", e);
            return nullData;
        }
    ...
    public Object[][] getBasicUserEnrolledInEstatements(Method method) {
        ...
        DatabaseUtils.updateCompanyAttributeValueString(CompanyAttribute.ACCOUNTS_ESTATEMENTS_ENABLED.getDefinition(), "true");
        D3Account account = user.getAssetAccounts().get(ThreadLocalRandom.current().nextInt(user.getAssetAccounts().size()));
        ...
        try {
            ...
            logger.error("Error enrolling in Estatements through the api", e);
            return nullData;
        }

        return new Object[][] {{user, account}};
    }
    ...
    public Object[][] getBasicUserWithOfflineLiabilityAccount(Method method) {
        ...
        try {
            ...
            logger.error("Error adding offline liability account through the api", e);
            return nullData;
        }
    ...
    public Object[][] getBasicUserWithOfflineAssetAccount(Method method) {
        ...
        try {
            ...
            logger.error("Error adding offline asset account through the api", e);
            return nullData;
        }
