...
public class MoneyMovementDataProviders extends DataProviderBase {
    ...
    public Object[][] getUserWithRecipients(Method method) {
        ...
        try {
            ...
            logger.error("Issue Creating an average user with Bill Pay", e);
        }
        if (user == null) {
    ...
    public Object[][] getUserWithPayMultipleTransfers(Method method) {
        ...
        try {
            ...
            if (user == null) {
                logger.error("Error generating average user with bill pay");
                return errorObject;
            }
            ...
            logger.error("Issue creating Average User with bill pay and recipients", e);
            return errorObject;
        }
    ...
    public Object[][] getUserWithPayMultipleTemplate(Method method) {
        ...
        try {
            ...
            logger.error("Issue creating Average User with Worksheet Template", e);
            return errorObject;
        }

        if (recipients == null || transfers.isEmpty()) {
            logger.error("No Recipients or Pay Multiple Transfers were found");
            return errorObject;
        }
    ...
    public Object[][] getBadRecipientData(Method method) {
        ...
        try {
            ...
            logger.error("Issue creating Average User with Bill Pay", e);
        }
        if (user == null) {
            return new Object[][] {{null, null}};
        }
    ...
    public Object[][] getRecurringTransfers(Method method) {
        ...
        for (RecurringTransfer transfer : transfers) {
            ...
            try {
                ...
                logger.error("Error adding recurring transfer: {}", transfer, e);
                return errorObject;
            }
        }
    ...
    public Object[][] getUserWithActiveEbillers(Method method) {
        ...
        try {
            ...
            DatabaseUtils.deleteFromUserSyncOperation(user);
    ...
    public Object[][] getUserWithActiveEbillersAndAutoPayData(Method method) {
        ...
        for (AutoPay.PayOn type : payOnType) {
            ...
            if (data == null || data[0][0] == null) {
                logger.error("Wasn't able to create the user or add active ebiller");
