from create_test_run import get_test_case_list, create_test_run
from get_api_client import get_api_client
...
def get_case_ids_from_test_ids(test_ids: list) -> list:
    """
...
if __name__ == '__main__':
    ids = get_test_case_list('demo_test_ids.txt')
    list_of_tests = get_case_ids_from_test_ids(ids)
    create_test_run('3.3.1-rc1 - Demo Smoke', list_of_tests, milestone_id=107)
